                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse">
                    <div class="accordion-body">
                        <div class="infos d-flex flex-wrap pb-2">
                            <span class="col-12 col-sm-7 col-md-9">Email : lolodelastreet@gmail.com</span>
                            <span class="col-8 col-sm-4 col-md-2">DEVISE : EUR</span>
                            <span class="col-4 col-sm-1 col-lg-1 d-flex justify-content-end clear-button align-items-center"><i class="fa-solid fa-trash fa-xl"></i></span>
                            <br>
